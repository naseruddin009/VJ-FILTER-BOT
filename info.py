...
API_ID = int(environ.get('API_ID', '25213012'))
API_HASH = environ.get('API_HASH', '6968d03e8a3873171165208f1372784e')
BOT_TOKEN = environ.get('BOT_TOKEN', "7473860637:AAEt9IEW1aZGcr4grA9QngVGDQogxkr5GmU")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '2105438451'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5102358241').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '2197175503').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://moviekhor009:Naser:009@cluster0.reiwv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://moviekhor009:Naser:009@cluster0.reiwv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
